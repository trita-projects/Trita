...
const brands = [
  { title: `Roll the Dice`, to: `/brands/roll-the-dice`, desc: `Game collections, workshops, corporate programs.` },
  { title: `TolluGatti`, to: `/brands/tollugatti`, desc: `Digital board games, mindful play, community events.` },
  { title: `UnCamp`, to: `/brands/uncamp`, desc: `Thematic camps and family learning programs.` },
  { title: `Dahi Handi`, to: `/brands/dahi-handi`, desc: `Cultural festivals, youth engagement, heritage celebrations.` },
]
    ...
    <SiteLayout>
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-ink-950/70">
          Explore Tritā’s ecosystem of brands and programs.
        </p>
      </header>
