          ...
          <div className="grid gap-0 md:grid-cols-[2fr_1fr_1fr_1fr]">
            ...
            <div className="flex flex-col justify-between gap-6 border-b border-border p-8 md:border-b-0 md:border-r">
              <div className="space-y-3">
                <div className="font-heading text-2xl font-bold text-foreground">Trita Infotainment LLP</div>
            ...
            <div className="flex flex-col gap-4 p-8">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <a href="mailto:namaste@trita.in" className="font-body text-sm font-bold text-primary no-underline transition-all hover:opacity-80">
                    namaste@trita.in
                  </a>
                  <a href="tel:+919342184698" className="font-body text-sm font-bold text-primary no-underline transition-all hover:opacity-80">
                    +91 93421 84698
                  </a>
                </div>
              </div>
          ...
          <div className="border-t border-border bg-muted/10 px-8 py-6">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex gap-6">
                <Link to="/privacy" className="font-body text-xs text-muted-foreground no-underline hover:text-foreground">
                  Privacy Policy
                </Link>
