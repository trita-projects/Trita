        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="text-sm text-ink-950/70 no-underline transition hover:text-ink-950 hover:no-underline"
              rel="noopener noreferrer"
              target="_blank"
            >
              <span className="border-b border-transparent pb-0.5 transition hover:border-marigold-500">Instagram</span>
            </a>
            <a
              ...
              target="_blank"
            >
              <span className="border-b border-transparent pb-0.5 transition hover:border-marigold-500">LinkedIn</span>
            </a>
            <a
              ...
              target="_blank"
            >
              <span className="border-b border-transparent pb-0.5 transition hover:border-marigold-500">YouTube</span>
            </a>
          </div>
        </div>
          ...
          <nav className="grid gap-2" aria-label="Footer">
            {footerLinks.map(item => (
              <Link
                key={item.to}
                to={item.to}
                className="group inline-flex w-fit text-sm text-ink-950/70 no-underline transition hover:text-ink-950 hover:no-underline"
              >
                <span className="border-b border-transparent pb-0.5 transition group-hover:border-marigold-500">
                  {item.label}
                </span>
              </Link>
            ))}
